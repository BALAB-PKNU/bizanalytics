...
_ANSWER_DIGESTS.update({
    ...
    'week03|1|n0': ['int', None, 'cd4f38c9422c656a'],
    'week03|2|m0': ['int', None, 'e63afa6a00aaa164'],
    'week03|3|m0': ['int', None, 'b8764ae09dfd89f8'],
    'week03|3|n0': ['int', None, '724b109e5e364e16'],
    'week03|3|pf0': ['num', 0.0001, '8ab459a3d9890ad9'],
    'week03|4|n_rules': ['int', None, '01a8f53a027f77a5'],
    'week03|4|prevented#pending > 0': ['int', None, '0862a64ef1489ba0'],
    'week03|4|prevented#pending > 1': ['int', None, '769aa9b593117bbe'],
    'week03|4|prevented#pending > 16': ['int', None, '1a2615d2f4a7a08d'],
    'week03|4|prevented#pending > 4': ['int', None, '20d2287018e21ea6'],
    'week03|4|replaced#pending > 0': ['int', None, 'b7d1f5b1b3aaf027'],
    'week03|4|replaced#pending > 1': ['int', None, 'ef1036c815ec5a94'],
    'week03|4|replaced#pending > 16': ['int', None, '5ccfe7f914a25598'],
    'week03|4|replaced#pending > 4': ['int', None, 'bedd8173d9b09988'],
    'week03|5|cost20#after failure': ['num', 0.0001, '86ac58ba80185db1'],
    'week03|5|cost20#pending > 0': ['num', 0.0001, 'c8b1b9edf85fa154'],
    'week03|5|cost20#pending > 1': ['num', 0.0001, '6de2a5e9092e6634'],
    'week03|5|cost20#pending > 16': ['num', 0.0001, '707696d8c612ae70'],
    'week03|5|cost20#pending > 4': ['num', 0.0001, 'f4bb3976a9df7d33'],
    'week03|5|n_choices': ['int', None, 'd8b1959ac2e50253'],
    'week03|6|best20': ['str', None, '05e434152945f742'],
    'week03|6|best5': ['str', None, '49492a20f11febbe'],
    'week03|6|best50': ['str', None, '7c7dc78cbb398a77'],
    'week03|6|cost20#after failure': ['num', 0.0001, 'eae6195923c6b67e'],
    'week03|6|cost20#pending > 0': ['num', 0.0001, 'ea7779eec78f9c73'],
    'week03|6|cost20#pending > 1': ['num', 0.0001, '42de88ce56435e25'],
    'week03|6|cost20#pending > 16': ['num', 0.0001, '9474841bcff6432e'],
    'week03|6|cost20#pending > 4': ['num', 0.0001, 'b864117004f37c4f'],
    'week03|6|cost5#after failure': ['num', 0.0001, '42e09b6b7443a5bd'],
    'week03|6|cost5#pending > 0': ['num', 0.0001, '90e216efc007b4d4'],
    'week03|6|cost5#pending > 1': ['num', 0.0001, 'd43757aefd30c876'],
    'week03|6|cost5#pending > 16': ['num', 0.0001, '86ee9b3b45c01b59'],
    'week03|6|cost5#pending > 4': ['num', 0.0001, '50dbc78177032471'],
    'week03|6|cost50#after failure': ['num', 0.0001, '2485c8d6511524a6'],
    'week03|6|cost50#pending > 0': ['num', 0.0001, 'd674cfb81de5d5db'],
    'week03|6|cost50#pending > 1': ['num', 0.0001, '3cf7d0ae8b17f0a3'],
    'week03|6|cost50#pending > 16': ['num', 0.0001, '98ae2faf242202b3'],
    'week03|6|cost50#pending > 4': ['num', 0.0001, 'e95a7f6c598f7b58'],
    ...
    'week04|2|cas_diff': ['num', 0.1, 'caf1206e319f5593'],
    'week04|2|reg_diff': ['num', 0.1, 'e2ea6b990016d7e6'],
    'week04|3|reg_beta': ['num', 0.1, 'd5252eacf78d75d0'],
    'week04|4|cas_beta': ['num', 0.1, 'a5de4f4dc11d06dc'],
    'week04|5|cas_high': ['num', 0.1, '13e6b52bfa658200'],
    'week04|5|cas_low': ['num', 0.1, 'de225c54947f5022'],
    'week04|5|reg_high': ['num', 0.1, 'e4e766f913934281'],
    'week04|5|reg_low': ['num', 0.1, '120346dcd4d4db2d'],
    'week04|6|cas_adj_ratio': ['num', 0.001, 'f1b0a55fe69778f9'],
    'week04|6|cas_naive_ratio': ['num', 0.001, '6aaca045f138e4a9'],
    'week04|6|reg_adj_ratio': ['num', 0.001, '14cf51da2050080d'],
    'week04|6|reg_naive_ratio': ['num', 0.001, '1dd59faf3f93419a'],
    'week05|1|fn_half': ['int', None, '7a3dab83caaafc4e'],
    'week05|1|fp_half': ['int', None, '5a7aec0901bb3ada'],
    'week05|2|cost_all_val': ['int', None, '3adfc6802aeb65b1'],
    'week05|2|cost_half_val': ['int', None, '39d69d86df7bef39'],
    'week05|2|cost_none_val': ['int', None, '1e34317b6c4fc000'],
    'week05|3|cost_default': ['num', 48.6, '2b8455e27888c2d1'],
    'week05|3|threshold_default': ['num', 1e-06, '6bc3b28133c9f83a'],
    'week05|4|chosen_costs#0': ['num', 1.0, '54ec0710cd048b21'],
    'week05|4|chosen_costs#1': ['num', 1.0, '0683cf5c120f31c2'],
    'week05|4|chosen_costs#2': ['num', 1.0, 'd5e2a866ed6afc5b'],
    'week05|4|chosen_costs#3': ['num', 1.0, 'bc9af064b4d402a8'],
    'week05|4|chosen_thresholds#0': ['num', 1e-06, 'ed1bb74854928d89'],
    'week05|4|chosen_thresholds#1': ['num', 1e-06, '14897288d9e7a285'],
    'week05|4|chosen_thresholds#2': ['num', 1e-06, '8ed0e00e91c00d8a'],
    'week05|4|chosen_thresholds#3': ['num', 1e-06, '2e10de80ad230051'],
    'week05|4|selected': ['rows', None, '6ca370b1001e6f2b'],
    'week05|5|evaluated': ['rows', None, 'e140a6f488ce0dfd'],
    'week05|5|test_costs#0': ['num', 1.0, '0f70aacb3c0a4e35'],
    'week05|5|test_costs#1': ['num', 1.0, 'bd29ad06c61c8ad6'],
    'week05|5|test_costs#2': ['num', 1.0, '3ab267da8da7261d'],
    'week05|5|test_costs#3': ['num', 1.0, '46618a0ee5aaf8a8'],
    'week05|5|test_fn#0': ['num', 1.0, '9b60caec3a13d90a'],
    'week05|5|test_fn#1': ['num', 1.0, '442ac9fb6e99e775'],
    'week05|5|test_fn#2': ['num', 1.0, 'f3e56f5f035e5258'],
    'week05|5|test_fn#3': ['num', 1.0, 'c0e797dcb06758a0'],
    'week05|5|test_fp#0': ['num', 1.0, '12c424e9f7a0ca41'],
    'week05|5|test_fp#1': ['num', 1.0, '91ffc6253bcfaa3d'],
    'week05|5|test_fp#2': ['num', 1.0, '4f62761a27b1aaf7'],
    'week05|5|test_fp#3': ['num', 1.0, '2d4645821ad56d2b'],
    'week05|6|cost_ratios#0': ['num', 0.001, 'f3316838ce1aecac'],
    'week05|6|cost_ratios#1': ['num', 0.001, '8374b99e62184c58'],
    'week05|6|cost_ratios#2': ['num', 0.001, 'c1844b466ca22a98'],
    'week05|6|cost_ratios#3': ['num', 0.001, '3f08b15ac3f652e6'],
    'week05|6|half_test_costs#0': ['num', 1.0, 'ed93ec5b797bd4f1'],
    'week05|6|half_test_costs#1': ['num', 1.0, 'f48f9f9de854a166'],
    'week05|6|half_test_costs#2': ['num', 1.0, 'e73bec51d03e3375'],
    'week05|6|half_test_costs#3': ['num', 1.0, '82dda17fb5fbd3d0'],
    ...
    'week06|3|loop_cases#multiple': ['int', None, 'd7022173f9698c34'],
    'week06|3|loop_cases#single': ['int', None, 'f6a253633edc9db9'],
    'week06|3|loops_per_case#multiple': ['num', 0.001, 'd32cd08ff44324f7'],
    'week06|3|loops_per_case#single': ['num', 0.001, 'ac9107759dab3470'],
    'week06|4|phase_counts#multiple': ['int', None, '6a249b7e314b3e34'],
    'week06|4|phase_counts#single': ['int', None, 'de6b1481f00ace91'],
    'week06|4|phase_mean#multiple': ['num', 0.01, 'dfd4e7ff17c73a99'],
    'week06|4|phase_mean#single': ['num', 0.01, '589d8e390180ece2'],
    'week06|4|phase_median#multiple': ['num', 0.01, 'f6ee824ed83eecac'],
    'week06|4|phase_median#single': ['num', 0.01, '8f08ae9c21f7a0f7'],
    'week06|5|accepted_counts#multiple': ['int', None, '276f636cc373ba4a'],
    'week06|5|accepted_counts#single': ['int', None, '112c9e55d15944ac'],
    'week06|5|incomplete_rate#multiple': ['num', 0.001, '8a68980e487e6d58'],
    'week06|5|incomplete_rate#single': ['num', 0.001, 'f2a7303d29d5572b'],
    'week06|6|mean_days#multiple': ['num', 0.01, 'ee9cf07eddbe4d95'],
    'week06|6|mean_days#single': ['num', 0.01, '1c2fcace281d5491'],
    'week06|6|mean_rounds#multiple': ['num', 0.01, '544fc1e9e93f3dd3'],
    'week06|6|mean_rounds#single': ['num', 0.01, '90099efcdd932549'],
